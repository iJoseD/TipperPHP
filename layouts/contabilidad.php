...
<div class="container">
    <div class="row mt-5">
        <div class="col-12">
            <h4>Registros contables</h4><hr>
        </div>
        <div class="row mt-3">
            <div class="d-grid col-3">
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#modalNuevoRegistro">Nuevo registro</button>
            </div>
            <div class="d-grid col-3">
                <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#modalNuevoAbono">Nuevo abono</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalNuevoRegistroLabel">Aagregar nuevo registro</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-4">
                            <label for="formGroupExampleInput" class="form-label">Curso Comprado</label>
                        ...
                        <div class="col-4">
                            <label for="formGroupExampleInput" class="form-label">Valor del curso</label>
                            <input type="text" class="form-control" id="formGroupExampleInput">
                        </div>
                        <div class="col-4">
                            <label for="formGroupExampleInput" class="form-label">Medio de pago</label>
                            <select class="form-select" aria-label="Default select example">
                                <option selected>Seleccione...</option>
                    ...
                    <div class="row mt-3">
                        <div class="col-4">
                            <label for="formGroupExampleInput" class="form-label">Formas de pago</label>
                            <select class="form-select" aria-label="Default select example">
                                <option selected>Seleccione...</option>
                        ...
                        <div class="col-4">
                            <label for="formGroupExampleInput" class="form-label">Fechas de pago</label>
                            <select class="form-select" aria-label="Default select example">
                                <option selected>Seleccione...</option>
                                <option value="Exorcismo">Exorcismo</option>
                                <option value="Liberación">Liberación</option>
                        ...
                        <div class="col-4">
                            <label for="formGroupExampleInput" class="form-label">Saldo pendiente</label>
                            <input type="text" class="form-control" id="formGroupExampleInput">
                        </div>
                    </div>
                </div>
    ...
    <!-- Nuevo abono -->
    <div class="modal fade" id="modalNuevoAbono" tabindex="-1" aria-labelledby="modalNuevoAbonoLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalNuevoAbonoLabel">Aagregar nuevo registro</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
