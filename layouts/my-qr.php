...
<section class="container s--myqr">
    ...
    <div class="row">
        ...
        <div class="card col-10">
            <div class="card-body">
                <img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=https://thankyoutipper.com/payments/?id=<?php echo $encryptedPhone; ?>&choe=UTF-8" alt="Generate QR Code">
